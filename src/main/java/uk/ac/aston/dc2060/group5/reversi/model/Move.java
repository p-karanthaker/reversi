...
public class Move {
  ...
  public static boolean makeMove(Board board, int row, int col, Piece pieceToPlace) {
    ...
    List<AbstractTile> surroundingPieces =
        getOppositePieces(getSurroundingTiles(row, col, board), pieceToPlace);
   ...
   * @return a list of pieces of the opposite colour from the passed in piece from the list of tiles
   * passed in
   */
